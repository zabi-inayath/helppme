      ...
      <div>
        <div className="flex flex-col items-center min-h-screen bg-gray-100 py-8">
          ...
          <div className="border border-gray-300 rounded-lg max-w-80 mt-24 font-san shadow-lg">
            <div className="p-3 rounded-t-lg bg-[#D7E0FF] flex justify-between items-center text-[#465CAA] border-b border-black-300">
              <span className="font-semibold">Utilities</span>
              <img
                className="h-8"
                src="https://res.cloudinary.com/dhcfcubwa/image/upload/v1740983973/UtilitiesTool_dycphl.svg"
              />
            </div>
            <div className="p-4 rounded-b-lg bg-[#EFF2FF]">
              <div
                className="py-3 border-b border-gray-300 flex justify-between items-center text-gray-700 cursor-pointer"
                onClick={() => navigate(`/utilities/electricians`)}
              >
              ...
              <div
                className="py-3 border-b border-gray-300 flex justify-between items-center text-gray-700 cursor-pointer"
                onClick={() => navigate(`/utilities/plumbers`)}
              >
              ...
              <div
                className="py-3 border-b border-gray-300 flex justify-between items-center text-gray-700 cursor-pointer"
                onClick={() => navigate(`/utilities/gas-agencies`)}
              >
                <span className="font-medium">Gas Agencies</span>
                <img src="https://res.cloudinary.com/dhcfcubwa/image/upload/v1740983401/chevron-left_yxwgrs.svg" />
              </div>
              <div
                className="py-3 border-b border-gray-300 flex justify-between items-center text-gray-700 cursor-pointer"
                onClick={() => navigate(`/utilities/house-cleaners`)}
              >
                <span className="font-medium pr-30">House Cleaners</span>
                <img src="https://res.cloudinary.com/dhcfcubwa/image/upload/v1740983401/chevron-left_yxwgrs.svg" />
              </div>
              <div
                className="py-3 flex justify-between items-center text-gray-700 cursor-pointer"
                onClick={() => navigate(`/utilities/pest-controls`)}
              >
