          ...
          <div className="flex flex-col items-center min-h-screen bg-gray-100 py-8">
            ...
            <div className="flex absolute top-20 left-1/2 transform -translate-x-1/2 bg-white border border-blue-500 rounded-full shadow-xl px-3 py-2 w-11/12 max-w-md">
              ...
              <input
                type="search"
                required
                placeholder="Search for Line Man"
            ...
            <div className="border border-gray-300 rounded-lg max-w-80 mt-24 font-san shadow-lg">
              <div className="p-3 rounded-t-lg bg-[#FFF1A5] flex justify-between items-center text-[#AB9210] border-b border-black-300">
                <span className="font-semibold">Public</span>
                <img
                  className="h-8"
                  src="https://res.cloudinary.com/dhcfcubwa/image/upload/v1740983836/publicTool_dgveo5.svg"
                />
              </div>
              <div className="p-4 rounded-b-lg bg-[#f7f2d4]">
                <div
                  className="py-3 border-b border-gray-300 flex justify-between items-center text-gray-700 cursor-pointer"
                  onClick={() => navigate(`/public/municipal-corporations`)}
                >
                  <span className="font-medium pr-18">
                ...
                <div
                  className="py-3 border-b border-gray-300 flex justify-between items-center text-gray-700 cursor-pointer"
                  onClick={() => navigate(`/public/water-suppliers`)}
                >
                  <span className="font-medium">Water Suppliers</span>
                  <img src="https://res.cloudinary.com/dhcfcubwa/image/upload/v1740983401/chevron-left_yxwgrs.svg" />
                </div>
                <div
                  className="py-3 border-b border-gray-300 flex justify-between items-center text-gray-700 cursor-pointer"
                  onClick={() => navigate(`/public/electricity-board`)}
                >
                  <span className="font-medium">Electricity Board</span>
                  <img src="https://res.cloudinary.com/dhcfcubwa/image/upload/v1740983401/chevron-left_yxwgrs.svg" />
                </div>
                <div
                  className="py-3 border-b border-gray-300 flex justify-between items-center text-gray-700 cursor-pointer"
                  onClick={() => navigate(`/public/e-gov-centers`)}
                >
                  <span className="font-medium">E-Gov Centers</span>
                  <img src="https://res.cloudinary.com/dhcfcubwa/image/upload/v1740983401/chevron-left_yxwgrs.svg" />
                </div>
                <div
                  className="py-3 flex justify-between items-center text-gray-700 cursor-pointer"
                  onClick={() => navigate(`/public/postal-service`)}
                >
                  <span className="font-medium">Postal Services</span>
                  <img src="https://res.cloudinary.com/dhcfcubwa/image/upload/v1740983401/chevron-left_yxwgrs.svg" />
                </div>
              </div>
            </div>
