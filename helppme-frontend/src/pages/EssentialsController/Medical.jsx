        ...
        <div>
          <div className="flex flex-col items-center min-h-screen bg-gray-100 py-8">
            ...
            <div className="border border-gray-300 rounded-lg max-w-80 mt-24 font-san shadow-lg">
              <div className="p-3 rounded-t-lg bg-[#CCEDED] flex justify-between items-center text-[#0A8F91] border-b border-black-300">
                <span className="font-semibold">Medical</span>
                <img
                  className="h-8"
                  src="https://res.cloudinary.com/dhcfcubwa/image/upload/v1740983553/medicalPlus_irl6ks.svg"
                />
              </div>
              <div className="p-4 rounded-b-lg bg-[#dbecec]">
                <div
                ...
                <div
                  className="py-3 border-b border-gray-300 flex justify-between items-center text-gray-700 cursor-pointer"
                  onClick={() => navigate(`/medical/ambulance-services`)}
                >
                  <span className="font-medium pr-22">Ambulance Services</span>
                  <img src="https://res.cloudinary.com/dhcfcubwa/image/upload/v1740983401/chevron-left_yxwgrs.svg" />
                </div>
                <div
                  className="py-3 border-b border-gray-300 flex justify-between items-center text-gray-700 cursor-pointer"
